...
// Unit tests
describe('components/common/Form/FormHL', () => {
  describe('Default state', () => {
    it('should render without crashing', () => {
      // Shallow rendering
      const wrapper = shallow(<FormHL />);
    ...
    describe('"children"', () => {
      describe('Receiving prop', () => {
        it('should receive the correct prop', () => {
          ...
          // Full DOM rendering
          const wrapper = mount(<FormHL {...props} />);
        ...
        it('should render the correct children', () => {
          ...
          // Shallow rendering
          const wrapper = shallow(<FormHL>{props.children}</FormHL>);
