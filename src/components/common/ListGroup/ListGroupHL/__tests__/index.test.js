...
// Unit tests
describe('components/common/ListGroup/ListGroupHL', () => {
  describe('Default state', () => {
    it('should render without crashing', () => {
      // Shallow rendering
      const wrapper = shallow(<ListGroupHL />);
    ...
    describe('"children"', () => {
      describe('Receiving prop', () => {
        it('should receive the correct prop', () => {
          ...
          // Full DOM rendering
          const wrapper = mount(<ListGroupHL {...props} />);
        ...
        it('should render the correct children', () => {
          ...
          // Shallow rendering
          const wrapper = shallow(<ListGroupHL>{props.children}</ListGroupHL>);
