...
const expected = {
  state: {
    ...
    domain: mock.data.initial.getIn(['screens', 'surveys', 'new']),
    initial: fromJS(stateShape)
  }
};
...
// Unit tests
describe('screens/surveys/new/reducers', () => {
  describe('Asynchronous', () => {
    ...
    describe('Update state', () => {
      describe('Create survey', () => {
        it('should handle SURVEY_CREATE_REQUEST action', () => {
          // Mock data
          const state = source.state.initial;
          const action = { type: SURVEY_CREATE_REQUEST };
        ...
        it('should handle SURVEY_CREATE_FAILURE action', () => {
          // Mock data
          const state = source.state.initial;
          const payload = source.state.error;
          const action = { type: SURVEY_CREATE_FAILURE, payload };
        ...
        it('should handle SURVEY_CREATE_SUCCESS action', () => {
          // Mock data
          const state = source.state.initial;
          const action = { type: SURVEY_CREATE_SUCCESS };
          const result = expected.state.initial;
      ...
      describe('Reset state', () => {
        it('should handle SURVEY_RESET_UI action', () => {
          // Mock data
          const state = source.state.initial;
          const action = { type: SURVEY_RESET_UI };
          const result = expected.state.initial;
